...
const getCourseTheme = (code) => {
  switch (code) {
    case 'PF101': return { icon: '💻', color: 'from-blue-500 to-purple-500' };
    case 'DSA303': return { icon: '📊', color: 'from-green-500 to-teal-500' };
    case 'WD202': return { icon: '🌐', color: 'from-orange-500 to-red-500' };
    case 'DS404': return { icon: '🗃️', color: 'from-indigo-500 to-blue-500' };
